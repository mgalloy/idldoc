...
pro teapot
    ...
    ;; Use GET_BOUNDS to determine the ranges of the data in the three
    ;; coordinate dimensions. Use this information to translate the
    ;; data to the origin of the coordinate system. Next, use SET_VIEW
    ;; to scale the coordinate system to the largest dimension of the
    ;; data, plus a little padding. Last, move the position of the
    ;; directional light source (ol1) to the near upper right corner
    ;; of the view volume.
